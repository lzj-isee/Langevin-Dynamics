...
sgld=np.load('./result/SGLD/SGLD lr[2.00e-01,0.00,0.00].npy')
svrgld=np.load('./result/SVRGLD/SVRGLD lr[2.00e-01,0.00,0.00].npy')
raisld=np.load('./result/RAISLD/RAISLD lr[2.00e-01,0.00,0.00] alpha[0.10] d[1.0].npy')
raislde=np.load('./result/RAISLDe/RAISLDe lr[2.00e-01,0.00,0.00] alpha[0.10] d[1.0].npy')
