...
train_datas=torchvision.datasets.MNIST(root='./DataSet',train=True,download=True,transform=transform)
test_datas=torchvision.datasets.MNIST(root='./DataSet',train=False,download=True,transform=transform)
