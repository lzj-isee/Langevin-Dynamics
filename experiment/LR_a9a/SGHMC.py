...
def _SGHMC_iter(lr_a,lr_gamma,friction,num_epochs,train_set,train_loader,full_train_loader,\
    ...
    for epoch in range(num_epochs):
        for i, (features,labels) in enumerate(train_loader):
            ...
            param_v=param_v-eta*(gamma*param_v+grad)+noise
...
def SGHMC_trian(lr_a,lr_gamma,friction,num_epochs,batchSize,print_interval,random_seed,save_folder):
    ...
    print('SGHMC: lr_a:{}, lr_gamma:{}, friction:{}'.format(lr_a,lr_gamma,friction))
    train_loss,train_corr,test_loss,test_corr=_SGHMC_iter(
